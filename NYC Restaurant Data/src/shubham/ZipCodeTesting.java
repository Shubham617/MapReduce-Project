...
public class ZipCodeTesting {
	...
	public void testReducer(){
		...
		reduceDriver.addOutput(new Text("MANHATTAN"), new Text(10022+"   Number of restaurants with critical violations: " + 1));
	...
	public void testMapReduceSingleProduct(){
		...
		mapReduceDriver.addOutput(new Text("MANHATTAN"), new Text(10022+"   Number of restaurants with critical violations: " + 1));
